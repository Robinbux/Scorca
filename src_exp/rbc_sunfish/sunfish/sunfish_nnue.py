...
L0, L1, L2 = 10, 10, 10
model = pickle.load(open('/Users/robinbux/Desktop/RBC_New/src/rbc_sunfish/sunfish/nnue/models/tanh.pickle', "br"))
        ...
        def moves():
            ...
            for move in sorted(pos.gen_moves(), key=mvv_lva):
                ...
                #print(mvv_lva(move)*360)
                    ...
                    pos_move = pos.move(move)
                    all_moves.append((move, -self.bound(pos_move, 1-gamma, depth-1, False)))
            return all_moves
